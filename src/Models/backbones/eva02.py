...
class Attention(nn.Module):
    def __init__(
        ...
        self.inner_attn_ln = build_norm_layer(all_head_dim, **norm_cfg)[1] if subln else nn.Identity()
    ...
    def get_attn_map(self, x, rel_pos_bias=None, attn_mask=None):
        B, N, C = x.shape
...
class EVA_02_VisionTransformer(nn.Module):
